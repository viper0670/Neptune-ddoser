...
NEPTUNE_BANNER = 'NEPTUNE DDOS v0.1 by Dylan Donnelly '
...
class neptune(object):
    ...
    def exit(self):
        self.stats()
        print("Shutting down NeptuneDDOS")
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} neptune strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(NEPTUNE_BANNER)
    print()
    print(' USAGE: ./neptune.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        neptune = neptune(url)
        neptune.useragents = useragents
        neptune.nr_workers = workers
        neptune.method = method
        neptune.nr_sockets = socks
